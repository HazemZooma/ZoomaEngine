...
public class Triangle extends Shape {
    ...
    public Triangle(float posX, float posY, float base, float height, float[] color) {
    ...
    private Triangle(float posX, float posY, float base, float height, float[] color, TriangleType type) {
        super(posX, posY, color);
        this.base = base;
        this.height = height;
        this.type = type;
    ...
    public static Triangle createEquilateral(float posX, float posY, float side, float[] color) {
        float height = (float) (Math.sqrt(3) / 2 * side);
        return new Triangle(posX, posY, side, height, color, TriangleType.EQUILATERAL);
    }

    public static Triangle createIsosceles(float posX, float posY, float base, float height, float[] color) {
        return new Triangle(posX, posY, base, height, color, TriangleType.ISOSCELES);
    }

    public static Triangle createRight(float posX, float posY, float base, float height, float[] color) {
        return new Triangle(posX, posY, base, height, color, TriangleType.RIGHT);
    }

    public static Triangle createScalene(float posX, float posY, float base, float height, float[] color) {
        return new Triangle(posX, posY, base, height, color, TriangleType.SCALENE);
    }

    public float getWidth() { return base; }
